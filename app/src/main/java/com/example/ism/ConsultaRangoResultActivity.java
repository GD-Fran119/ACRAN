...
public class ConsultaRangoResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView = (ExpandableListView) findViewById(R.id.elvClases);
        createListView();
    }
    ...
    private void createListView(){
        ...
        if(groupList.isEmpty()){
            Toast.makeText(contexto, "No existen clases para esta aula en el rango especificado", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private ArrayList<String> getChildren(String fecha){
        ...
        try {
            ...
            for(int i = 0; i < array.length(); ++i){
                ...
                String asignatura = jasonsito.getString("asignatura");
                String grado = jasonsito.getString("grado");
