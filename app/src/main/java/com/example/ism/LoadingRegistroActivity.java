...
public class LoadingRegistroActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        String data = intencion.getStringExtra("data");
    ...
    public void onRequestFinished(){
        Intent intencion = new Intent(contexto, RegistroResultActivity.class);
        startActivity(intencion);
        overridePendingTransition(R.transition.new_activity_entrada, R.transition.new_activity_salida);
    }
